...
setlocale(LC_ALL,"portuguese");
    do{
        ...
        switch(escolha){
            ...
            case 2:busca();
                break;
            case 3:lista_clientes();
                break;
            case 4:cadastrar_produto();
                break;
            case 5:atualizar_estoque();
                break;
            case 6:listar_estoque();
                break;
            case 7:vendas();
                break;
            case 8:lucro();
        ...
        for(i=0;i<ALL;i++){
            ...
            if(codigo_c[i]==codigo_busca){
                ...
                if(codigo_p[i]==codigo_p1){
                    ...
                    switch(op){
                        case 1: printf("Total a pagar: R$ %.2f",venda);
                            break;
                        case 2: fatura_c[i]=fatura_c[i]+venda;printf("Valor adicionado à fatura");
                            break;
                    }
                }
            }
